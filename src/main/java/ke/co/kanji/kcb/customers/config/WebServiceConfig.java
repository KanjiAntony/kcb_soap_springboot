package ke.co.kanji.kcb.customers.config;
...
public class WebServiceConfig extends WsConfigurerAdapter {
    ...
    @Bean(name = "kcbCustomer")
    public DefaultWsdl11Definition defaultWsdl11Definition(XsdSchema customerSchema)
    {
        DefaultWsdl11Definition wsdl11Definition = new DefaultWsdl11Definition();
        wsdl11Definition.setPortTypeName("KcbCustomersPort");
        wsdl11Definition.setLocationUri("/ws");
        wsdl11Definition.setTargetNamespace("http://kanji.co.ke/kcb/customers");
